...
#define I2C_SDA_PIN     (0*32 + 24)
#define I2C_SCL_PIN     (0*32 + 25)
...
{
    uint32_t val =  rt_pin_read(I2C_SCL_PIN);
...
int rt_i2c1_init(void)
{
    ...
    rt_pin_write(I2C_SCL_PIN, 1);
    rt_pin_write(I2C_SDA_PIN, 1);
    

	return RT_EOK;
}

INIT_DEVICE_EXPORT(rt_i2c1_init);
